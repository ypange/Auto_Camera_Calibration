...
cap = cv.VideoCapture("/home/jaiama/Auto_Camera_Calibration/data_videos/vlc-record-2019-05-15-15h14m11s-vlc-record-2019-05-15-15h08m07s-GOPR0133.MP4-.mp4-.mp4")
...
while (1):
    ...
    positions.append(good_new)

with open('positions', 'wb') as fp:
    pkl.dump(positions, fp)
